...
//     const regions = [
//         { name: "I'm flexible", map: "https://via.placeholder.com/100x100?text=World" },
//         { name: "Europe", map: "https://via.placeholder.com/100x100?text=Europe" },
//         { name: "Italy", map: "https://via.placeholder.com/100x100?text=Italy" },
//         { name: "United States", map: "https://via.placeholder.com/100x100?text=US" },
//         { name: "Greece", map: "https://via.placeholder.com/100x100?text=Greece" },
//         { name: "South America", map: "https://via.placeholder.com/100x100?text=S.America" },
//       ]
...
//                                     <img src={`/path/to/${region.map}.png`} alt={region.name} />
